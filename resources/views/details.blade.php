...
<section class="header_text sub">
  <img class="img-responsive" src="{{url('/')}}/{{pictureHelper($pdt->id, $pdt->picture1, $pdt->picture2, $pdt->picture3)}}" width="400" alt="New products" >
  @endforeach
  ...
  <div class="row">
    <div class="col-sm-12">
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/')}}/{{replace($pdt->cname)}}/{{$pdt->cid}}">{{$pdt->cname}}</a></li>
        <li><a href="{{url('/')}}/{{replace($pdt->cname)}}/{{replace($pdt->scname)}}/{{$pdt->cid}}">{{$pdt->scname}}</a></li>
        <li></li>
        @endforeach
      </ol>
    </div>
