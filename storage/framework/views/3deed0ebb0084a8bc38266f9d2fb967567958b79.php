      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <table style="align: center; width: 600px; margin: 0 auto; celpadding:0;" >
            <form action="<?php echo e(url('/product-management/update')); ?>" method="post" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>

              <input type="hidden" name="id" value="<?php echo e($pdt->id); ?>" />
              <tr>
                <td><label>Title:</label></td>
                <td><input type="text" name="title" value="<?php echo e($pdt->title); ?>"></td>
              </tr>
              <tr>
                <td><label>Price:</label></td>
                <td><input type="text" name="price" value="<?php echo e($pdt->price); ?>"></td>
              </tr>
              <tr>
                <td><label>stock:</label></td>
                <td><input type="text" name="stock" value="<?php echo e($pdt->stock); ?>"></td>
              </tr>
              <tr>
                <td><label>discount:</label></td>
                <td><input type="text" name="discount" value="<?php echo e($pdt->discount); ?>"></td>
              </tr>
              <tr>
                <td><label>description:</label></td>
                <td><textarea name="description" rows="4" cols="50"><?php echo File::get(storage_path("app/product/{$pdt->id}.txt")); ?></textarea></td>
              </tr>
