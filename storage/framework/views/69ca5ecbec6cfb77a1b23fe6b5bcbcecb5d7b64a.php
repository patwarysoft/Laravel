      ...
      <div class="row">
        <div class="span12">
          ...
          <div id="myCarousel2" class="myCarousel carousel slide">
            <div class="carousel-inner">
              <?php $c = 1; ?>
              <?php $__currentLoopData = $allData[3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($c%4==1): ?>
              <div class="<?php echo e(($c==1)?"active ":""); ?>item">
                <ul class="thumbnails">			
              <?php endif; ?>									
